...
const Detail = () => {
    ...
    if (Object.keys(error) > 0) {
        return <div>Ha ocurrdo un evento ...</div>
    }
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.seatInfoContainer}>
                ...
                <p className={styles.priceRangeLegend}>Rango de precios {eventData.priceRanges?.[0].min}-{eventData.princeRanges?.[0].max} {eventData.priceRanges?.[0].currency}</p>
            </div>
